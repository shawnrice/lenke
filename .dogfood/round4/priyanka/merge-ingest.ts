...
const batch = [
  ...
  { type: 'edge', id: 'm-fresh', from: 'u-none', to: 'g-fresh', labels: ['MEMBER_OF'], properties: {} },
  { type: 'edge', id: 'grant-fresh', from: 'g-fresh', to: 'r-folderA', labels: ['EDITOR'], properties: {} },
]
...
console.log('after ingest:  canEdit(u-none, r-deepdoc) =', canEdit('u-none', 'r-deepdoc'), '(expect true)');
